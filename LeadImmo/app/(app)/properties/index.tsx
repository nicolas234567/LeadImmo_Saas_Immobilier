...
import { View, Image, Text, StyleSheet, TouchableOpacity, ActivityIndicator, Modal, ScrollView, TextInput, Platform } from 'react-native'
...
export default function Properties() {
  ...
  async function pickImage() {
    if (Platform.OS !== 'web') {
      ...
      if (status !== 'granted') {
        crossAlert('Permission refusée', "L'accès à la galerie est requis.")
        return
      }
    }
